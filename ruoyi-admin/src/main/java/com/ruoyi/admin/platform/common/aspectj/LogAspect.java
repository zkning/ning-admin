package com.ruoyi.admin.platform.common.aspectj;
...
import com.ruoyi.admin.platform.common.enums.BusinessStatus;
...
public class LogAspect {
    ...
    // 配置织入点
    @Pointcut("@annotation(com.ruoyi.admin.platform.common.annotation.Log)")
